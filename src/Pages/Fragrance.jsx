...
export const Fragrance = () => {
  ...
  return (
    <div className='w-full transition-all'>
      <h1 className='text-green-focus border-b font-bold text-xl p-2 sticky top-20 z-10 mx-2 bg-white'>Fragrance</h1>
      <div className='grid grid-cols-4 gap-4 mx-2 mt-2'>
        {
          items.filter((item) => item.category == 'fragrances').map((item) => {
            return (
