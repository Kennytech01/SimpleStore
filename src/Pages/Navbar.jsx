    ...
    <div className={`${isActive ? 'bg-[#461a44] text-stone-50' : 'bg-stone-50 bg-gradient-to-tr bg-clip-text text-transparent from-[#781d75] to-[#EC094D]'} z-40 fixed top-0 w-full transition-all shadow`}>
        <div className='flex justify-between items-center h-20 bg-whit'>
            ...
            <div className='mx-2 relative'>
                <p className={`${isActive? 'bg-gradient-to-r bg-clip-text text-transparent from-[#e2d9e1] to-[#EC094D]' : null} font-bold text-3xl  text-center`}>SimpleStore</p>
            </div>
            ...
            {/* right-Side */}
            <div>
                <ul className={`${isActive? 'bg-gradient-to-r bg-clip-text text-transparent from-[#e2d9e1] to-[#EC094D]' : null} hidden md:flex items-center px-5`} >
