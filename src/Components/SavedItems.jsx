...
export const SavedItems = () => {
  return (
    <div className='bg-white rounded shadow h-screen'>
      <h1 className='border-b p-5 text-xl font-bold bg-white sticky top-32 md:top-20 transition-all text-green-focus'>Saved Items</h1>
