...
export const Product = ({product}) => {
    const {id, title, discountPercentage,price, brand, rating, thumbnail} = product
...
return (
    <div className=''>
        <div  className='rounded h-96 flex flex-col justify-between sm:p-4 p-1 bg-white shadow'>
            <div key={id} onClick={()=>handleClick(product)} className='h-4/5 flex group flex-col justify-center'>
