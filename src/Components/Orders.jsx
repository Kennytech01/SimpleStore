...
export const Orders = () => {
  return (
    <div className='bg-white rounded shadow h-screen w-full'>
      <h1 className='border-b p-5 text-xl top-32 md:top-20 sticky text-green-focus bg-white font-bold'>Orders</h1>
