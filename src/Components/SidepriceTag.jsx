    ...
    <div>
      {
        isOpen ? (
            ...
            : (
          <div onClick={handleClose} className='fixed top-1/2 md:right-0 -right-40 transition-all duration-300 bg-[#781d75] h-20 w-20 text-stone-100 font-bold px-1 flex flex-col justify-around items-center shadow'>
